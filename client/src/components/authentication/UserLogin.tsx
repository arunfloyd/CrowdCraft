...
const UserLogin = () => {
  ...
  return (
    <div className="bg-white-100 flex min-h-screen items-center justify-center">
      <form className="mx-auto w-full max-w-lg rounded-2xl border border-gray-200 bg-white p-8 shadow-2xl">
      <div>
       ...
       <div>
        <p className="p-2 font-serif ">New to the Town ? <Link to="/register"><span className="font-bold ">Click Here</span></Link></p>
       </div>
      </form>
    </div>
  );
